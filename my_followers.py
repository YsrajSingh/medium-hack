...
# Define the API URL
url = "https://keentolearn.medium.com/_/graphql"
...
if not os.path.exists("user_followers.json"):
    with open("user_followers.json", "w") as file:
        json.dump([], file)
...
# Save all user data to a single JSON file
with open("user_followers.json", "w") as file:
